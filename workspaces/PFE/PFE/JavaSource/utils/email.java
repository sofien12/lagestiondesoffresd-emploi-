	...
	Properties props=new Properties();
	 props.put("mail.smtp.auth", "true");
	    ...
	    try{
	    	...
	    	message.setContent("<h:body>"+"<h1>bienvenue a attijari recrutement </h1><b>Description de la declaration :</b>"+desc+"<br/><br/><br/><br/><b>Nom du demandeur :</b>"+nom+"<br/><br/><b>Date de l'incident :</b>"+date+"<br/><form action='http://localhost:7080/PFE/modules/members/Enregistre.jsf' method='get'>	<button type='submit'  >Activer compte </button><form></h:body>","text/html ; charset=utf-8");
